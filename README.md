...
## Sleep Disorder
In the pie chart below, it displays the percentage value of the sleep disorders found in the dataset. The small amount of the people (20.6%) from the dataset appears to insomnia. Insomnia is a sleep disorder characterize by difficulty falling asleep, staying asleep, or both. Around 20.9% have sleep apnea, a condition that in which a person's breathing stops and restarts many times during sleep. There are around 58.6% who don't have a sleep disorder. 
